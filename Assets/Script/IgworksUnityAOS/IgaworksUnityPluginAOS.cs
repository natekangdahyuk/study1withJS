...
#pragma warning restore 0414
    ...
    public class IgaworksUnityPluginAOS : MonoBehaviour
    {
        ...
        // Add IgawUnityPlugin_aos_connector_v1.0.36.jar : AdPopcorn v5.1.8a Delegate
        public delegate void onLoadPopupAdSuccess();
        public static onLoadPopupAdSuccess OnLoadPopupAdSuccess;

        public delegate void onLoadPopupAdFailure(string apErrorMessage);
        public static onLoadPopupAdFailure OnLoadPopupAdFailure;

        public delegate void onShowPopupAdSuccess();
        public static onShowPopupAdSuccess OnShowPopupAdSuccess;

        public delegate void onShowPopupAdFailure(string apErrorMessage);
        public static onShowPopupAdFailure OnShowPopupAdFailure;

        public delegate void onPopupAdClose();
        public static onPopupAdClose OnPopupAdClose;      
	...
	static AndroidJavaClass _igaworksUnityPluginAosClass = null;
        ...
        public static class Common
        {
			...
			Debug.Log ("IGAWorksAdbrixUnityPlugin Call gdprForgetMe!!!");
...
#pragma warning restore 0414    // suppress value not used warning
            ...
            public class Currency
            {
                ...
                public static string ID_IDR = "IDR";//Indonesia
                public static string IN_INR = "INR";//India
                public static string RU_RUB = "RUB";//Russia
                public static string TH_THB = "THB";//Thailand
                public static string GB_GBP = "GBP";//England
                public static string VN_VND = "VND";//Vietnam
                public static string MY_MYR = "MYR";//Malaysia
            }
...
#pragma warning restore 0219
            ...
            public static class Commerce
            {
                ...
                public static void viewHome()
                {
                    ...
                    Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID             
				_igaworksUnityPluginAosClass.CallStatic("viewHome");
#endif
                }
            }
        ...
        public static class Adpopcorn
        {
			...
			public static void setCashRewardAppFlag(bool flag)
			{
#if UNITY_EDITOR
				Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
				_igaworksUnityPluginAosClass.CallStatic("setCashRewardAppFlag", flag);
#endif
			}

            // 유니티에서는 팝업 광고 사용 시, 매체가 직접 권한 설정 및 체크하도록
            /*public static void checkRequiredPermission()
            {
                _igaworksUnityPluginAosClass.CallStatic("checkRequiredPermission");
            }

            public static void onRequestPermissionsResult(int request_code, string[] permissions, int[] grantResults)
            {
                _igaworksUnityPluginAosClass.CallStatic("onRequestPermissionsResultUnity", request_code, permissions, grantResults);
            }
            */
            public static void loadPopupAd()
            {
                ...
                Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
				_igaworksUnityPluginAosClass.CallStatic("loadPopupAd");
#endif
            }
            ...
            public static void showPopupAd()
            {
                ...
                Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
				_igaworksUnityPluginAosClass.CallStatic("showPopupAd");
#endif
            }
        }
        ...
        public static class LiveOps
        {
            ...
            public static void registerFCMToken(string token)
            {
                ...
                Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
            _igaworksUnityPluginAosClass.CallStatic ("registerFCMToken",token);
#endif
            }
...
#pragma warning restore 0219
            foreach (string item in pList)
            {
                ...
                Debug.Log("AP.Unity : onSendCouponSucceedForUnity : 첫번째" + message + "두번째" + itemKey + "세번쨰" + itemName + "네번째" + quantity);
            }
#if UNITY_EDITOR
            Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
		Debug.Log("AP.Unity : onSendCouponSucceedForUnity : " + param);
        Debug.Log("AP.Unity : onSendCouponSucceedForUnity : " + message + itemKey + itemName + quantity);
        ...
        public void onReceivePopupDeeplinkDataForUnity(string deeplink)
        {
        ...
        // Add IgawUnityPlugin_aos_connector_v1.0.36.jar : AdPopcorn v5.1.8a Delegate
        public void OnLoadPopupAdSuccessForUnity(string result)
        {

#if UNITY_EDITOR
            Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
			Debug.Log("AP.Unity : OnLoadPopupAdSuccessForUnity");
			if (OnLoadPopupAdSuccess != null)
				OnLoadPopupAdSuccess ();
#endif

        }

        public void OnLoadPopupAdFailureForUnity(string apErrorMessage)
        {

#if UNITY_EDITOR
            Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
			Debug.Log("AP.Unity : OnLoadPopupAdFailureForUnity");
			if (OnLoadPopupAdFailure != null)
				OnLoadPopupAdFailure (apErrorMessage);
#endif

        }

        public void OnShowPopupAdSuccessForUnity(string result)
        {

#if UNITY_EDITOR
            Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
			Debug.Log("AP.Unity : OnShowPopupAdSuccessForUnity");
			if (OnShowPopupAdSuccess != null)
				OnShowPopupAdSuccess ();
#endif
        }

        public void OnShowPopupAdFailureForUnity(string apErrorMessage)
        {

#if UNITY_EDITOR
            Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
			Debug.Log("AP.Unity : OnShowPopupAdFailureForUnity");
			if (OnShowPopupAdFailure != null)
				OnShowPopupAdFailure (apErrorMessage);
#endif

        }

        public void OnPopupAdCloseForUnity(string result)
        {

#if UNITY_EDITOR
            Debug.Log("igaworks:Editor mode Connected");
#elif UNITY_ANDROID
			Debug.Log("AP.Unity : OnPopupAdCloseForUnity");
			if (OnPopupAdClose != null)
				OnPopupAdClose ();
#endif
